...
save_dir = "models/VGGNet/ILSVRC2016/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/ILSVRC2016/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/ILSVRC2016/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/ILSVRC2016/results/{}_score/".format(os.environ['HOME'], job_name)
